    ...
    class TextProcessingCode(ComponentCode):
        ...
        def apply(self, spark: SparkSession, in0: DataFrame) -> DataFrame:
            ...
            if self.props.operation == "text_split_into_chunks":
                ...
                chunk_overlap = str(self.props.chunk_overlap)
                return in0.withColumn("result_chunks", expr(f"text_split_into_chunks({column_name}, {chunk_size}, {chunk_overlap})"))
